...
DATABASES = {
    "default": {
        ...
        "NAME": env.str("POSTGRES_DB", default="weather"),
...
# Weather
INTEGRATION_BASE_URL = env.str("INTEGRATION_BASE_URL", default="set-url")
INTEGRATION_TIMEOUT = env.int("INTEGRATION_TIMEOUT", default=5)
INTEGRATION_API_KEY = env.str("INTEGRATION_API_KEY", default='set-api-key')
